#---------------------------------------------------------------------
# LCM and HCFs from Coding Challenges (EASY - solution)
# by Silvio Duka
#
...
def lcm(number1, number2):
    ...
    for i in range(number, (number1 * number2) + 1, number):
...
print("The LCM of [" + str(number1) + "," + str(number2) + "] is " + str(lcm(number1, number2)))
print("The HCF of [" + str(number1) + "," + str(number2) + "] is " + str(hcf(number1, number2)))